...
import { IndexedPokemon, IndexedType, ListPokemon, PokemonListResponse, PokemonByTypeListResponse } from "../interface/pokemonInterface";
...
const usePokemons = () => {
    ...
    const indexedPokemonToListPokemon = (indexedPokemon: IndexedPokemon) => {
        const pokedexNumber = parseInt(
            indexedPokemon.url.replace(`${POKEMON_API_POKEMON_URL}/`, "").replace("/","")
        );
